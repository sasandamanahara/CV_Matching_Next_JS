...
export default function PostAJob() {
    ...
    const [formData, setFormData] = useState({ user: user ? user._id : "", title: "", salary: 0, email: "", company: "", description: "", job_category: "", job_type: "", job_experience: "", job_vacancy: 0, job_deadline: "" });
