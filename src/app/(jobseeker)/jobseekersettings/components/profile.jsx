...
export default function Profile() {
  ...
  const handleLoad = async (event) => {
    ...
    if (res.success) {
      ...
      const { profilePicture, name, dateOfBirth, gender, phoneNo, message } =
        res.profile;
      console.log(name);
      setFormData({
        profilePicture,
                  ...
                  <img
                    src={
                      formData.profilePicture
                        ? formData.profilePicture
                        : "https://static.vecteezy.com/system/resources/previews/016/774/583/non_2x/3d-user-icon-on-transparent-background-free-png.png"
                    }
